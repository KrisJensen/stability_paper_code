...
# %% plot behavioral similarity (right-hand side of panel b)
...
#ax.plot_surface(X, Y, Z, rstride=1, cstride=1, vmin = np.amax(Z)-0.65, vmax=np.amax(Z)+0.45,
#                cmap='Greys', linewidth=0, antialiased=False, alpha=0.95)

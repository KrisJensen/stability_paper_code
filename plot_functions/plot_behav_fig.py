...
#ax.text(-0.2, 1.20, 'B', transform=ax.transAxes,fontsize=panel_font, fontweight='bold', horizontalalignment='left', verticalalignment='top')
ax.plot(xs, m, 'k-')
...
print('example neural-behav correlation:', pearsonr(ex_sim_n, ex_sim_b))
...
plt.savefig('../paper_figs/fig_behav.png', bbox_inches = 'tight', dpi = png_dpi)
plt.savefig('../paper_figs/fig_behav.pdf', bbox_inches = 'tight')
plt.close()

...
for ilab, label in enumerate(labels):
    ...
    if label[1] == 1:
        ...
        #ax.text(-0.1, 1.05, 'A', transform=ax.transAxes,fontsize=panel_font, fontweight='bold', horizontalalignment='right', verticalalignment='bottom')
...
for i, name in enumerate(unit_rats):
    ...
    if i == 0:
        ...
        #ax.text(-0.2, 1.05, 'C', transform=ax.transAxes,fontsize=panel_font, fontweight='bold', horizontalalignment='right', verticalalignment='bottom')
...
#axs[0].text(-0.1, 1.05, 'B', transform=axs[0].transAxes,fontsize=panel_font, fontweight='bold', horizontalalignment='right', verticalalignment='bottom')
...
for i in range(2):
    ...
    if i == 0:
        ...
        #ax.text(-0.5, 1.1, 'D', transform=ax.transAxes,fontsize=panel_font, fontweight='bold', horizontalalignment='right', verticalalignment='bottom')
    else:
        ax.set_yticks([])
...
plt.savefig('../paper_figs/fig_exp.png', bbox_inches = 'tight', dpi = png_dpi)
plt.savefig('../paper_figs/fig_exp.pdf', bbox_inches = 'tight')
plt.close()

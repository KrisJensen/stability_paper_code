...
#plt.savefig('../paper_figs/Sfig_modulation.png', bbox_inches = 'tight') 
plt.savefig('../paper_figs/Sfig_modulation.png', bbox_inches = 'tight', dpi = png_dpi)
plt.savefig('../paper_figs/Sfig_modulation.pdf', bbox_inches = 'tight')
#plt.show()
plt.close()